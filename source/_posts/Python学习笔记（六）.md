...
<p style="color:red;">使用`__slots__`要注意，`__slots__`定义的属性仅对当前类实例起作用，对继承的子类是不起作用的：</p>
...
![](http://i.imgur.com/KZGy4FV.png)

但是如果按照“能跑”和“能飞”来归类，我们就应该设计出这样的类的层次：

![](http://i.imgur.com/v3uxEG5.png)
...
1. class的名称；
2. 继承的父类集合，注意Python支持多重继承，<p style="color:red;">如果只有一个父类，别忘了tuple的单元素写法；</p>
