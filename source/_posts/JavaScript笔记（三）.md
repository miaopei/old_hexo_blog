---
title: JavaScript笔记（三）
date: 2017-07-05 19:57:35
tags: JavaScript
reward: true
...
这是因为浏览器的同源策略导致的。<p style="color:red;">默认情况下，JavaScript在发送AJAX请求时，URL的域名必须和当前页面完全一致。</p>
