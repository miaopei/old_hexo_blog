...
function e(t, n, r) {
    ...
    2 : [function() {
        ...
        function(e, t) {
            ...
            function x(e, t, n, r) {
                for (var i = n === (r ? "border": "content") ? 4 : "width" === t ? 1 : 0, o = 0; 4 > i; i += 2)"margin" === n && (o += K.css(e, n + mn[i], !0)),
                r ? ("content" === n && (o -= parseFloat(nn(e, "padding" + mn[i])) || 0), "margin" !== n && (o -= parseFloat(nn(e, "border" + mn[i] + "Width")) || 0)) : (o += parseFloat(nn(e, "padding" + mn[i])) || 0, "padding" !== n && (o += parseFloat(nn(e, "border" + mn[i] + "Width")) || 0));
                return o
            }
            function w(e, t, n) {
            ...
            function N(e) {
                return function(t, n) {
                    ...
                    s = 0,
                    u = a.length;
                    if (K.isFunction(n)) for (; u > s; s++) r = a[s],
                    o = /^\+/.test(r),
                    o && (r = r.substr(1) || "*"),
                    i = e[r] = e[r] || [],
                    i[o ? "unshift": "push"](n)
            ...
            function C(e, n, r, i, o, a) {
                ...
                a = a || {},
                a[o] = !0;
                for (var s, u = e[o], l = 0, c = u ? u.length: 0, f = e === _n; c > l && (f || !s); l++) s = u[l](n, r, i),
                "string" == typeof s && (!f || a[s] ? s = t: (n.dataTypes.unshift(s), s = C(e, n, r, i, s, a)));
                return (f || !s) && !a["*"] && (s = C(e, n, r, i, "*", a)),
                s
            }
            function S(e, n) {
            ...
            function O(e, t, n) {
                ...
                u = a.promise({
                    ...
                    stop: function(t) {
                        for (var n = 0,
                        r = t ? u.tweens.length: 0; r > n; n++) u.tweens[n].run(1);
            ...
            function F(e, t, n) {
                ...
                n.queue || (l = K._queueHooks(e, "fx"), null == l.unqueued && (l.unqueued = 0, c = l.empty.fire, l.empty.fire = function() {
                    ...
                    f.always(function() {
                        l.unqueued--,
                        K.queue(e, "fx").length || l.empty.fire()
                    })
                })),
                ...
                n.overflow && (d.overflow = "hidden", K.support.shrinkWrapBlocks || f.done(function() {
            ...
            K.extend = K.fn.extend = function() {
                ...
                u = 2), "object" != typeof s && !K.isFunction(s) && (s = {}), l === u && (s = this, --u); l > u; u++) if (null != (e = arguments[u])) for (n in e) r = s[n],
                i = e[n],
            ...
            K.extend({
                ...
                ready: function(e) {
                    if (e === !0 ? !--K.readyWait: !K.isReady) {
                        ...
                        K.isReady = !0,
                        e !== !0 && --K.readyWait > 0 || (W.resolveWith(R, [K]), K.fn.trigger && K(R).trigger("ready").off("ready"))
                    }
                },
            ...
            K.ready.promise = function(t) {
                if (!W) if (W = K.Deferred(), "complete" === R.readyState || "loading" !== R.readyState && R.addEventListener) setTimeout(K.ready, 1);
                else if (R.addEventListener) R.addEventListener("DOMContentLoaded", dt, !1),
                e.addEventListener("load", K.ready, !1);
                else {
                    R.attachEvent("onreadystatechange", dt),
            ...
            K.Callbacks = function(e) {
                ...
                f = function(t) {
                    ...
                    o = !1,
                    l && (c ? c.length && f(c.shift()) : r ? l = [] : d.disable())
                },
                d = {
                    add: function() {
                        if (l) {
                            ...
                            function n(t) {
                                K.each(t,
                                function(t, r) { ! K.isFunction(r) || e.unique && d.has(r) ? r && r.length && n(r) : l.push(r)
                                })
                            } (arguments),
                    ...
                    remove: function() {
                        return l && K.each(arguments,
                        function(e, t) {
                            for (var n; (n = K.inArray(t, l, n)) > -1;) l.splice(n, 1),
                            o && (s >= n && s--, u >= n && u--)
                        }),
                        this
                    },
            ...
            K.support = function() {
                ...
                c = u in d,
                c || (d.setAttribute(u, "return;"), c = "function" == typeof d[u]),
                t[l + "Bubbles"] = c;
                return K(function() {
            ...
            K.extend({
                ...
                data: function(e, n, r, i) {
                    if (K.acceptData(e)) {
                        ...
                        c = l ? K.cache: e,
                        f = l ? e[s] : e[s] && s;
                        if (f && c[f] && (i || c[f].data) || !u || r !== t) return f || (l ? e[s] = f = K.deletedIds.pop() || ++K.uuid: f = s),
                        c[f] || (c[f] = {},
                        l || (c[f].toJSON = K.noop)),
                ...
                data: function(e, n) {
                    ...
                    if (e === t) {
                        if (this.length && (f = K.data(l), 1 === l.nodeType && !K._data(l, "parsedAttrs"))) {
                            for (a = l.attributes, u = a.length; u > c; c++) s = a[c].name,
                            0 === s.indexOf("data-") && (s = K.camelCase(s.substring(5)), r(l, s, f[s]));
            ...
            K.fn.extend({
                ...
                toggleClass: function(e, t) {
                    ...
                    function(n) {
                        ...
                        a = K(this), s = t, u = e.split(tt); i = u[o++];) s = r ? s: !a.hasClass(i),
                ...
                hasClass: function(e) {
                    for (var t = " " + e + " ",
                    n = 0,
                    r = this.length; r > n; n++) if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(xt, " ").indexOf(t) > -1) return ! 0;
                    return ! 1
                },
                val: function(e) {
                    var n, r, i, o = this[0]; {
            ...
            K.extend({
                ...
                removeAttr: function(e, t) {
                    ...
                    i && (n = K.propFix[i] || i, o = Ct.test(i), o || K.attr(e, i, ""), e.removeAttribute(St ? i: n), o && n in e && (e[n] = !1))
                },
                attrHooks: {
                    type: {
                        set: function(e, t) {
            ...
            K.event = {
                add: function(e, n, r, i, o) {
                    ...
                    if (3 !== e.nodeType && 8 !== e.nodeType && n && r && (a = K._data(e))) {
                        ...
                        s.elem = e), n = K.trim(Ot(n)).split(" "), l = 0; l < n.length; l++) c = At.exec(n[l]) || [],
                        f = c[1],
                        d = (c[2] || "").split(".").sort(),
                        m = K.event.special[f] || {},
                        ...
                        h),
                        g = u[f],
                        g || (g = u[f] = [], g.delegateCount = 0, m.setup && m.setup.call(e, i, d, s) !== !1 || (e.addEventListener ? e.addEventListener(f, s, !1) : e.attachEvent && e.attachEvent("on" + f, s))),
                ...
                remove: function(e, t, n, r, i) {
                    ...
                    if (m && (d = m.events)) {
                        for (t = K.trim(Ot(t || "")).split(" "), o = 0; o < t.length; o++) if (a = At.exec(t[o]) || [], s = u = a[1], l = a[2], s) {
                            for (p = K.event.special[s] || {},
                            s = (r ? p.delegateType: p.bindType) || s, h = d[s] || [], c = h.length, l = l ? new RegExp("(^|\\.)" + l.split(".").sort().join("\\.(?:.*\\.|)") + "(\\.|$)") : null, f = 0; f < h.length; f++) g = h[f],
                            !(!i && u !== g.origType || n && n.guid !== g.guid || l && !l.test(g.namespace) || r && r !== g.selector && ("**" !== r || !g.selector) || (h.splice(f--, 1), g.selector && h.delegateCount--, !p.remove || !p.remove.call(e, g)));
                ...
                trigger: function(n, r, i, o) {
                    if (!i || 3 !== i.nodeType && 8 !== i.nodeType) {
                        ...
                        if (n.result = t, n.target || (n.target = i), r = null != r ? K.makeArray(r) : [], r.unshift(n), d = K.event.special[m] || {},
                        d.trigger && d.trigger.apply(i, r) === !1) return;
                        if (h = [[i, d.bindType || m]], !o && !d.noBubble && !K.isWindow(i)) {
                            for (g = d.delegateType || m, l = Ht.test(g + m) ? i: i.parentNode, c = i; l; l = l.parentNode) h.push([l, g]),
                            c = l;
                            c === (i.ownerDocument || R) && h.push([c.defaultView || c.parentWindow || e, g])
                        }
                        for (u = 0; u < h.length && !n.isPropagationStopped(); u++) l = h[u][0],
                        n.type = h[u][1],
                        p = (K._data(l, "events") || {})[n.type] && K._data(l, "handle"),
                        p && p.apply(l, r),
                        p = f && l[f],
                        p && K.acceptData(l) && p.apply(l, r) === !1 && n.preventDefault();
                        return n.type = m,
                        !(o || n.isDefaultPrevented() || d._default && d._default.apply(i.ownerDocument, r) !== !1 || "click" === m && K.nodeName(i, "a") || !K.acceptData(i) || !f || !i[m] || ("focus" === m || "blur" === m) && 0 === n.target.offsetWidth || K.isWindow(i) || (c = i[f], c && (i[f] = null), K.event.triggered = m, i[m](), K.event.triggered = t, !c || !(i[f] = c))),
                        n.result
                    }
                },
                dispatch: function(n) {
                    ...
                    if (g[0] = n, n.delegateTarget = this, !y.preDispatch || y.preDispatch.call(this, n) !== !1) {
                        ...
                        for (p.length > h && v.push({
                            elem: this,
                            matches: p.slice(h)
                        }), r = 0; r < v.length && !n.isPropagationStopped(); r++) for (l = v[r], n.currentTarget = l.elem, i = 0; i < l.matches.length && !n.isImmediatePropagationStopped(); i++) f = l.matches[i],
                        (m || !n.namespace && !f.namespace || n.namespace_re && n.namespace_re.test(f.namespace)) && (n.data = f.data, n.handleObj = f, s = ((K.event.special[f.origType] || {}).handle || f.handler).apply(l.elem, g), s !== t && (n.result = s, s === !1 && (n.preventDefault(), n.stopPropagation())));
            ...
            K.support.changeBubbles || (K.event.special.change = {
                setup: function() {
                    return kt.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (K.event.add(this, "propertychange._change",
                    function(e) {
                    ...
                    function(e) {
                        var t = e.target;
                        kt.test(t.nodeName) && !K._data(t, "_change_attached") && (K.event.add(t, "change._change",
                        function(e) {
            ...
            function(e, t) {
                ...
                jt.test(t) && (K.event.fixHooks[t] = K.event.keyHooks),
                Lt.test(t) && (K.event.fixHooks[t] = K.event.mouseHooks)
            }),
            function(e, t) {
                function n(e, t, n, r) {
                    for (var i = 0,
                    o = t.length; o > i; i++) ot(e, t[i], n, r)
                }
                ...
                function i(e, i, o, a, s) {
                    for (var u, l, c, f, d, p, h, g, m = 0,
                    y = s.length,
                    v = z.POS,
                    b = new RegExp("^" + v.source + "(?!" + N + ")", "i"), x = function() {
                        for (var e = 1,
                        n = arguments.length - 2; n > e; e++) arguments[e] === t && (u[e] = t)
                    }; y > m; m++) {
                        for (v.exec(""), e = s[m], f = [], c = 0, d = a; u = v.exec(e);) g = v.lastIndex = u.index + u[0].length,
                        g > c && (h = e.slice(c, u.index), c = g, p = [i], M.test(h) && (d && (p = d), d = a), (l = W.test(h)) && (h = h.slice(0, -5).replace(M, "$&*")), u.length > 1 && u[0].replace(b, x), d = r(h, u[1], u[2], p, d, l));
                ...
                function o(e, t, n) {
                    for (var r, i, o, a = [], s = 0, u = _.exec(e), l = !u.pop() && !u.pop(), c = l && e.match(F) || [""], f = at.preFilter, d = at.filter, p = !n && t !== g; null != (i = c[s]) && l; s++) for (a.push(r = []), p && (i = " " + i); i;) {
                        l = !1,
                        (u = M.exec(i)) && (i = i.slice(u[0].length), l = r.push({
                ...
                it = Z(function(e) {
                    ...
                    e.getElementsByClassName && 0 !== e.getElementsByClassName("e").length ? (e.lastChild.className = "e", 1 !== e.getElementsByClassName("e").length) : !1
                }),
                ot = function(e, t, n, r) {
                    n = n || [],
                    t = t || g;
                    ...
                    if (a = ut(t), !a && !r && (i = q.exec(e))) if (s = i[1]) {
                        if (9 === u) {
                            ...
                            n
                        } else if (t.ownerDocument && (o = t.ownerDocument.getElementById(s)) && lt(t, o) && o.id === s) return n.push(o),
                        n
                    } else {
                        if (i[2]) return T.apply(n, w.call(t.getElementsByTagName(e), 0)),
                        n;
                        if ((s = i[3]) && it && t.getElementsByClassName) return T.apply(n, w.call(t.getElementsByClassName(s), 0)),
                        n
                    }
                    return dt(e, t, n, r, a)
                },
                at = ot.selectors = {
                    ...
                    preFilter: {
                        ...
                        CHILD: function(e) {
                            ...
                            "nth" === e[1] ? (e[2] || ot.error(e[0]), e[3] = +(e[3] ? e[4] + (e[5] || 1) : 2 * ("even" === e[2] || "odd" === e[2])), e[4] = +(e[6] + e[7] || "odd" === e[2])) : e[2] && ot.error(e[0]),
                            e
                        },
                        PSEUDO: function(e) {
                            var t, n = e[4];
                    ...
                    filter: {
                        ...
                        PSEUDO: function(e, t, n, r) {
                            ...
                            return i || ot.error("unsupported pseudo: " + e),
                ...
                ot.attr = function(e, t) {
                    ...
                    at.attrHandle[t] ? at.attrHandle[t](e) : et || r ? e.getAttribute(t) : (n = e.getAttributeNode(t), n ? "boolean" == typeof e[t] ? e[t] ? t: null: n.specified ? n.value: null: null)
                },
                ot.error = function(e) {
                ...
                var ft = ot.compile = function(e, t, n) {
                    ...
                    s.runs = s.dirruns = 0,
                    V.push(e),
                    V.length > at.cacheLength && delete Y[V.shift()],
                    s
                };
                ...
                var dt = function(e, t, n, r, o) {
                    ...
                    if (e) for (s = ft(e, t, o), f = s.dirruns++, null == a && (a = at.find.TAG("*", B.test(e) && t.parentNode || t)), u = 0; d = a[u]; u++) c = s.runs++,
                    s(d, t) && n.push(d);
                    return n
                };
                g.querySelectorAll &&
                function() {
                    ...
                    dt = function(e, r, o, a, s) {
                        if (! (a || s || i && i.test(e))) if (9 === r.nodeType) try {
                            return T.apply(o, w.call(r.querySelectorAll(e), 0)),
                            o
                            ...
                            try {
                                return T.apply(o, w.call(f.querySelectorAll(e.replace(F, "[id='" + c + "'] $&")), 0)),
                                o
                            } catch(u) {} finally {
            ...
            K.fn.extend({
                ...
                closest: function(e, t) {
                    for (var n, r = 0,
                    i = this.length,
                    o = [], a = Pt.test(e) || "string" != typeof e ? K(e, t || this.context) : 0; i > r; r++) for (n = this[r]; n && n.ownerDocument && n !== t && 11 !== n.nodeType;) {
            ...
            K.buildFragment = function(e, n, r) {
                ...
                1 === e.length && "string" == typeof s && s.length < 512 && n === R && "<" === s.charAt(0) && !Yt.test(s) && (K.support.checkClone || !Gt.test(s)) && (K.support.html5Clone || !Vt.test(s)) && (o = !0, i = K.fragments[s], a = i !== t),
            ...
            K.extend({
                ...
                clean: function(e, t, n, r) {
                    ...
                    for (t && "undefined" != typeof t.createDocumentFragment || (t = R), o = t === R && en; null != (a = e[y]); y++) if ("number" == typeof a && (a += ""), a) {
                        if ("string" == typeof a) if (Xt.test(a)) {
                            ...
                            if (!K.support.tbody) for (d = zt.test(a), p = "table" !== s || d ? "<table>" !== u[1] || d ? [] : f.childNodes: f.firstChild && f.firstChild.childNodes, i = p.length - 1; i >= 0; --i) K.nodeName(p[i], "tbody") && !p[i].childNodes.length && p[i].parentNode.removeChild(p[i]); ! K.support.leadingWhitespace && Rt.test(a) && f.insertBefore(t.createTextNode(Rt.exec(a)[0]), f.firstChild),
                            a = f.childNodes,
                            f = o.lastChild
                ...
                cleanData: function(e, t) {
                    ...
                    s = K.expando,
                    u = K.cache,
                    l = K.support.deleteExpando,
                    c = K.event.special; null != (i = e[a]); a++) if ((t || K.acceptData(i)) && (r = i[s], n = r && u[r])) {
            ...
            K.fn.extend({
                ...
                toggle: function(e, t) {
                    ...
                    return K.isFunction(e) && K.isFunction(t) ? vn.apply(this, arguments) : this.each(function() { (n ? e: y(this)) ? K(this).show() : K(this).hide()
                    })
                }
            }),
            K.extend({
                ...
                css: function(e, n, r, i) {
                    var o, a, s, u = K.camelCase(n);
                    return n = K.cssProps[u] || (K.cssProps[u] = m(e.style, u)),
            ...
            e.getComputedStyle ? nn = function(e, t) {
                ...
                s = e.style;
                return a && (n = a[t], "" === n && !K.contains(e.ownerDocument.documentElement, e) && (n = K.style(e, t)), fn.test(n) && ln.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = n, n = a.width, s.width = r, s.minWidth = i, s.maxWidth = o)),
                n
            }: R.documentElement.currentStyle && (nn = function(e, t) {
                var n, r, i = e.currentStyle && e.currentStyle[t],
                o = e.style;
                return null == i && o && o[t] && (i = o[t]),
                fn.test(i) && !un.test(t) && (n = o.left, r = e.runtimeStyle && e.runtimeStyle.left, r && (e.runtimeStyle.left = e.currentStyle.left), o.left = "fontSize" === t ? "1em": i, i = o.pixelLeft + "px", o.left = n, r && (e.runtimeStyle.left = r)),
                "" === i ? "auto": i
            }),
            K.each(["height", "width"],
            function(e, t) {
                K.cssHooks[t] = {
                    get: function(e, n, r) {
                        return n ? 0 !== e.offsetWidth || "none" !== nn(e, "display") ? w(e, t, r) : K.swap(e, hn,
                        function() {
                            return w(e, t, r)
                        }) : void 0
                    },
            ...
            K.fn.load = function(e, n, r) {
                ...
                K.ajax({
                    ...
                    a = arguments,
                    s.html(i ? K("<div>").append(e.replace(Hn, "")).find(i) : e)
                }),
                this
            },
            ...
            K.extend({
                ...
                ajaxSetup: function(e, t) {
                    return t ? S(e, K.ajaxSettings) : (t = e, e = K.ajaxSettings),
                    S(e, t),
                    e
                },
                ajaxSettings: {
                ...
                ajax: function(e, n) {
                    ...
                    n = n || {};
                    var i, o, a, s, u, l, c, f, d = K.ajaxSetup({},
                    n),
                    p = d.context || d,
                    ...
                    d.ifModified && (i = i || d.url, K.lastModified[i] && T.setRequestHeader("If-Modified-Since", K.lastModified[i]), K.etag[i] && T.setRequestHeader("If-None-Match", K.etag[i])),
                    T.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + qn + "; q=0.01": "") : d.accepts["*"]);
            ...
            function(n, r, i) {
                ...
                i.always(function() {
                    e[o] = a,
                    n[o] && (n.jsonpCallback = r.jsonpCallback, Wn.push(o)),
                    ...
                    return {
                        send: function(i, o) {
                            ...
                            r = function(e, i) {
                                var s, l, c, f, d;
                                try {
                                    if (r && (i || 4 === u.readyState)) if (r = t, a && (u.onreadystatechange = K.noop, Xn && delete zn[a]), i) 4 !== u.readyState && u.abort();
                                    else {
                                        s = u.status,
                            ...
                            n.async ? 4 === u.readyState ? setTimeout(r, 0) : (a = ++Un, Xn && (zn || (zn = {},
                            K(e).unload(Xn)), zn[a] = r), u.onreadystatechange = r) : r()
                        },
                        abort: function() {
                            r && r(0, 1)
                        }
                ...
                "*": [function(e, t) {
                    ...
                    if (a) {
                        if (n = +a[2], r = a[3] || (K.cssNumber[e] ? "": "px"), "px" !== r && u) {
                            ...
                            do i = l = l || ".5",
                            u /= l,
                            K.style(o.elem, e, u + r),
                            l = o.cur() / s;
                            while (1 !== l && l !== i)
                        }
                        o.unit = r,
                        o.start = u,
                        o.end = a[1] ? u + (a[1] + 1) * n: n
                    }
                    return o
                }]
            };
            ...
            K.offset = {
                ...
                setOffset: function(e, t, n) {
                    ...
                    f = {},
                    d = {};
                    c ? (d = a.position(), i = d.top, o = d.left) : (i = parseFloat(u) || 0, o = parseFloat(l) || 0),
    ...
    {}],
    3 : [function() {
        window.iPadMode = navigator.userAgent.match(/iP/i),
        window.supportsTouchEvents = "ontouchstart" in document.documentElement || /Android|webOS|iPhone|iPad|iPod|BlackBerry|Windows Phone|ZuneWP7/i.test(navigator.userAgent),
        document.all && !document.addEventListener && (document.documentElement.className += "" == document.documentElement.className ? "ie8minus": " ie8minus");
        var e = !1; ("undefined" == typeof console || "undefined" == typeof console.log) && (console = {},
        console.log = e ?
        function(e) {
            alert(e)
        }: function() {}),
        ...
        function(e) {
            ...
            e.deviceDescription.type = e.DEVICE_TYPES.desktop,
            navigator.userAgent.indexOf("iPad") > -1 ? e.deviceDescription.type = e.DEVICE_TYPES.iPad: navigator.userAgent.indexOf("iPhone") > -1 ? e.deviceDescription.type = e.DEVICE_TYPES.iPhone: navigator.userAgent.indexOf("Android") > -1 ? e.deviceDescription.type = e.DEVICE_TYPES.android: navigator.userAgent.indexOf("Windows Phone") > -1 && (e.deviceDescription.type = e.DEVICE_TYPES.wPhone),
            navigator.userAgent.indexOf("Chrome") > -1 ? e.deviceDescription.browser = e.BROWSERS.chrome: navigator.userAgent.indexOf("Safari") > -1 && (e.deviceDescription.browser = e.BROWSERS.safari),
            e.deviceDescription.os = void 0,
            navigator.userAgent.indexOf("Mac OS") > -1 ? e.deviceDescription.os = e.OS_TYPES.mac: navigator.userAgent.indexOf("Windows") > -1 && (e.deviceDescription.os = e.OS_TYPES.win),
            ("object" == typeof Touch || "ontouchstart" in document.documentElement) && (e.deviceDescription.touchCapable = !0),
            e.debu = window.location.href.indexOf("?debug") > -1;
            var t;
            e.debLog = function(e) {
                t && t.prepend($("<p>" + e + "</p>"))
            },
            $(function() {
                ...
                e.debLog(e.deviceDescription.type),
                e.debLog("Standard-touch-capable: " + e.deviceDescription.touchCapable)
            }),
            e.twoComponentLoad = {
                arr: [],
                componentsReady: 0,
