...
function e(t, n, i) {
    ...
    3 : [function() {
        particlesMaskFn = function() {
            ...
            this.initParticlesFromString = function(e, t) {
                ...
                o = n.getContext("2d");
                o.font = i,
                n.width = o.measureText(e).width,
                o.font = i,
                o.textBaseline = "bottom",
                o.fillText(e, 0, textSize);
            ...
            this.initParticlesFromImageData = function(e, t) {
                ...
                for (var n, i = 0; i < mask.w; i++) for (var o = 0; o < mask.h; o++) n = i + mask.w * o,
                mask.data[n] = e.data[4 * n + 3];
                this.alignToMask(t)
            },
            this.alignToMask = function(e) {
                for (var t = 0; t < e.count; t++) this.setParticleToRandomUnmaskedPixel(e.plainArray[t]),
                resetParticle(e.plainArray[t])
            },
            this.setParticleToRandomUnmaskedPixel = function(e) {
                var t;
                do t = Math.floor(Math.random() * mask.data.length);
                while (255 * Math.random() > mask.data[t]);
                var n = Math.floor(t / mask.w),
                i = t % mask.w;
                e.initial.x = (i + mask.dim.halfDelta.w + .5) / mask.dim.max * 2 - 1,
                e.initial.x *= shell404.maxRadius,
                e.initial.x += shell404.range( - mask.dim.halfCell, mask.dim.halfCell),
                e.initial.z = (n + mask.dim.halfDelta.h + .5) / mask.dim.max * 2 - 1,
                e.initial.z *= shell404.maxRadius,
                e.initial.z += shell404.range( - mask.dim.halfCell, mask.dim.halfCell)
            }
        },
    ...
    4 : [function() {
        function e() {
            function e(e) {
                return function(t) {
                    c.hsv[e] = rgb2hsv(t[0], t[1], t[2]),
                    c.hsv[e].h /= 360,
                    c.hsv[e].s /= 100,
                    c.hsv[e].v /= 100
                }
            }
            for (var t = ["sideColor", "seedColor"], n = new dat.GUI, i = 0, s = t[i]; i < t.length; i++, s = t[i]) c.hsv[s] = rgb2hsv(c[s][0], c[s][1], c[s][2]),
            c.hsv[s].h /= 360,
            c.hsv[s].s /= 100,
            c.hsv[s].v /= 100,
            n.addColor(c, t[i]).onChange(e(t[i]));
        ...
        function n(e) {
            function t() {
                for (var e = 0; e < r.length; e++) for (var t = 0; t < shell404.axises.length; t++) s[r[e]][shell404.axises[t]] = shell404.dRange(o)
            }
            function n() {
                a.ang = 0,
                o = shell404.range(1, 2.5),
                t()
            }
            function i() {
                var t = e.position,
                ...
                i = Math.cos(n),
                o = Math.sin(n);
                t.x = e.initial.x + i * s.a.x + o * s.b.x - s.a.x,
                t.y = e.initial.y + i * s.a.y + o * s.b.y - s.a.y,
                t.z = e.initial.z + i * s.a.z + o * s.b.z - s.a.z
            }
            var o = 30,
            s = {
                a: new THREE.Vector3,
            ...
            n(),
            e.tween = createjs.Tween.get(a, {
                loop: !0
            }).wait(200 * Math.random()).to(l, 1e3),
            e.tween.addEventListener("change", i)
        }
        function o(e) {
            var t = e ? e: c.background,
            n = new THREE.Color;
            n.setRGB(t[0] / 255, t[1] / 255, t[2] / 255),
            shell404.renderer.setClearColorHex(n.getHex(), 1)
        }
        function s() {
            var e = new THREE.Geometry,
            t = r(new THREE.Vector3(0, 0, 0), 200, 2, 0, 1, 2, 3, 4, 5, 6, 7),
            n = [];
            for (i = 0; i < t.length; i++) e.vertices.push(t[i]),
            n[i] = new THREE.Color(16777215),
            n[i].setHSV(.6, (200 + t[i].x) / 400, 1);
            e.colors = n,
            ...
            var o, s, a = 2,
            l = 2e3,
            d = [[material, 7 * a, [0, -l, 0], e]];
            for (i = 0; i < d.length; ++i) s = d[i],
            o = new THREE.Line(s[3], s[0]),
            o.scale.x = o.scale.y = o.scale.z = s[1],
            o.position.x = s[2][0],
            o.position.y = s[2][1],
            o.position.z = s[2][2],
            shell404.scene.add(o)
        }
        function r(e, t, n, i, o, s, a, l, d, c, u) {
            ...
            if (--n >= 0) {
                var m = [];
                return Array.prototype.push.apply(m, r(f[0], h, n, i, a, l, u, c, d, s, o)),
                Array.prototype.push.apply(m, r(f[1], h, n, i, u, c, o, s, d, l, a)),
                Array.prototype.push.apply(m, r(f[2], h, n, i, u, c, o, s, d, l, a)),
                Array.prototype.push.apply(m, r(f[3], h, n, s, a, i, o, c, u, l, d)),
                Array.prototype.push.apply(m, r(f[4], h, n, s, a, i, o, c, u, l, d)),
                Array.prototype.push.apply(m, r(f[5], h, n, l, a, s, d, c, o, i, u)),
                Array.prototype.push.apply(m, r(f[6], h, n, l, a, s, d, c, o, i, u)),
                Array.prototype.push.apply(m, r(f[7], h, n, c, d, s, o, i, a, l, u)),
                m
            }
            return f
        }
        ...
        var h = {
            ...
            init: function(e) {
                ...
                e.velocity.y = 0,
                e.velocity.z = 0,
                e.tween ? e.tween.setPaused(!1) : n(e)
            }
        },
        p = h;
        window.resetParticle = function(e) {
            e.position.x = e.initial.x,
            e.position.z = e.initial.z,
            e.position.y = shell404.floor,
            p.init(e)
        };
        var f = {
            point: {
            ...
            init: function() {
                f.point.obj = new THREE.PointLight(16777215, 1),
                f.point.obj.position.x = 0,
                f.point.obj.position.y = 400,
                f.point.obj.position.z = 0,
                shell404.scene.add(f.point.obj),
                f.ambient.obj = new THREE.AmbientLight(16777215),
                f.update(),
                shell404.scene.add(f.ambient.obj)
            },
            update: function() {
                f.point.obj.color = t(c.pointColor),
                f.ambient.obj.color = t(c.ambientColor)
            }
        };
        window.objectsInit = function() {
            shell404.showLights && f.init(),
            e(),
            shell404.guiEnabled || $(".dg.main.a").hide(),
            shell404.showPlane && plane(),
            shell404.showParticles && _.init(),
            o(),
            shell404.linePattern && s(),
            shell404.brandBackground && m.init()
        },
        ...
        var m = {
            ...
            init: function() {
                ...
                if (shell404.smallUnshiftedCube && (t = 100), shell404.skybox) {
                    ...
                    i.fillStyle = "rgb( 200, 200, 200 )",
                    i.fillRect(0, 0, n.width, n.height);
                    var o = [e(l + d), e(l + d), e(l + d), e(l + d), e(l + d), e(l + d)];
                    m.object = new THREE.Mesh(new THREE.CubeGeometry(t, t, t, 7, 7, 7), new THREE.MeshFaceMaterial(o)),
                    m.object.scale.x = -1
                } else {
                ...
                shell404.smallUnshiftedCube || (m.object.position.y += shell404.ceiling),
                shell404.scene.add(m.object)
            },
            update: function() {
                if (shell404.backgroundCubeMoving) {
                    var e = 5e-5 * shell404.time;
                    m.object.rotation.x = Math.sin(e) * Math.PI,
                    m.object.rotation.y = Math.cos(e) * Math.PI
                }
            }
        };
        ...
        var _ = {
            ...
            init: function() {
                ...
                i = function(e) {
                    return function(t) {
                        ...
                        t.fillStyle = "rgb(" + Math.floor(256 * e.color.r) + "," + +Math.floor(256 * e.color.g) + "," + +Math.floor(256 * e.color.b) + ")",
                        t.beginPath(),
                        t.arc(0, 0, 2, 0, n, !0),
                        t.closePath(),
                        t.fill()
                ...
                else _.geometry = new THREE.Geometry,
                _.geometry.colors = [],
                _.mat = new THREE.ParticleBasicMaterial({
                    size: 10,
                    vertexColors: !0,
                    blending: THREE.AdditiveBlending,
                    map: e,
                ...
                for (var s, r, d = 0; d < _.count; d++) {
                    if (r = new hotdot.particle(d), _.plainArray[d] = r, _.canvasMode) s = new THREE.Particle(shell404.canvasSettings.particlesFromImage ? t: o(r)),
                    r.position = s.position,
                    shell404.scene.add(s),
                    r.color = new THREE.Color(16711680);
                    else {
                        var s = new THREE.Vector3(0, 0, 0);
                        r.position = s,
                        _.geometry.vertices.push(s),
                        r.color = _.geometry.colors[d] = new THREE.Color(16711680)
                    }
                    _.plainArray[d] = r,
                    r.velocity = new THREE.Vector3(0, 0, 0),
                    r.initial = {
                        x: 0,
                        z: 0,
                        y: 0
                ...
                _.canvasMode || (_.threeObject = new THREE.ParticleSystem(_.geometry, _.mat)),
                particlesMask.initParticlesFromString(a, _),
                _.canvasMode || (_.threeObject.sortParticles = !0, shell404.scene.add(_.threeObject))
            },
            explodeParameters: {
                max: {
                    pow: 10,
            ...
            update: function() {
                if (0 != _.plainArray.length) {
                    for (var e, t, n, i, o, s, r, a, l, d = _.count; d--;) e = _.plainArray[d],
                    l = e.position,
                    a = e.velocity,
                    Math.abs(Math.sqrt(Math.pow(l.x, 2) + Math.pow(l.z, 2)) > 3 * shell404.maxRadius) && resetParticle(e),
                    t = Math.sqrt(Math.pow(l.x / shell404.maxRadius, 2) + Math.pow(l.z / shell404.maxRadius, 2)),
                    n = l.y / shell404.ceiling,
                    l.add(a),
                    p.step(e, shell404.time),
                    u && (o = Math.atan2(l.z - u.z, l.x - u.x), s = Math.sqrt(Math.pow(l.z - u.z, 2) + Math.pow(l.x - u.x, 2)), s < _.explodeParameters.max.dist && (r = (_.explodeParameters.max.pow - _.explodeParameters.min.pow) * (1 - s / _.explodeParameters.max.dist) + _.explodeParameters.min.pow, a.x = r * Math.cos(o), a.z = r * Math.sin(o), e.tween.setPaused(!0))),
                    i = e.color,
                    i.setRGB(_.mixRGB(0, t), _.mixRGB(1, t), _.mixRGB(2, t));
        ...
        window.updateObjects = function() {
            if (_.update(), shell404.linesConstructShouldRotate) for (var e = 0; e < shell404.scene.children.length; e++) {
            ...
            shell404.brandBackground && m.update(),
            u = !1,
            createjs.Tween.tick(shell404.deltaFrame, !1)
        },
    ...
    5 : [function() {
        ...
        window.shell404fn = function() {
            this.canvasMode = -1 == window.location.href.indexOf("webGL=true"),
            ...
            this.cubeBasicMaterial = !1,
            this.canvasSettings = {
                particlesFromImage: !1
            },
            this.smallUnshiftedCube = !1,
            this.skybox = this.canvasMode,
            this.brandBackground = !0,
            this.oldTweenLib = !1,
            this.backgroundCubeMoving = !1,
            this.linePattern = !1,
            this.linesConstructShouldRotate = !1,
            this.statsEnabled = window.location.href.indexOf("perf=true") > -1,
            this.mouse = {
                x: 0,
                y: 0
            },
            ...
            this.init = function() {
                ...
                function() {
                    ...
                    e.camera.aspect = e.ASPECT,
                    e.camera.updateProjectionMatrix()
                }),
                e.origin = new THREE.Vector3(0, 0, 0),
                e.renderer = e.canvasMode ? new THREE.CanvasRenderer: new THREE.WebGLRenderer,
                e.WIDTH = window.innerWidth,
                e.HEIGHT = window.innerHeight,
                e.renderer.setSize(e.WIDTH, e.HEIGHT),
                $("#container").append(e.renderer.domElement),
                ...
                function(t) {
                    ...
                    e.adaptiveCam.f.a = o.x * Math.PI * .5 - Math.PI / 4,
                    e.adaptiveCam.f.va = (1 - o.z) * Math.PI * .5 + Math.PI / 4,
                    e.lastMouseEvent = t
                }),
                $("canvas").on("mousedown",
                function(t) {
                ...
                e.ASPECT = e.WIDTH / e.HEIGHT,
                e.camera = new THREE.PerspectiveCamera(e.VIEW_ANGLE, e.ASPECT, e.NEAR, e.FAR),
                e.camera.a = e.adaptiveCam.s.a,
                e.camera.va = e.adaptiveCam.s.va,
                e.camera.up = new THREE.Vector3(0, 0, -1),
                e.applyCamAngles(),
                e.statsEnabled && (e.stats = new Stats, e.stats.domElement.style.position = "absolute", e.stats.domElement.style.top = "0px", e.stats.domElement.style.zIndex = 100, $("#container").append(e.stats.domElement)),
                e.projector = new THREE.Projector,
                objectsInit(),
                e.cl = new THREE.Clock,
                e.cl.start()
            },
            this.applyCamAngles = function() {
                shell404.camera.position.x = Math.sin(shell404.camera.a) * Math.sin(shell404.camera.va) * shell404.ceiling,
                shell404.camera.position.y = Math.cos(shell404.camera.a) * Math.sin(shell404.camera.va) * shell404.ceiling,
                shell404.camera.position.z = Math.cos(shell404.camera.va) * shell404.ceiling,
                shell404.camera.lookAt(shell404.origin)
            },
            this.update = function() {
                var e = shell404.cl.getElapsedTime();
                shell404.deltaFrame = Math.round(1e3 * (e - shell404.time)),
                shell404.time = e,
                updateObjects(),
                shell404.camera.a += (shell404.adaptiveCam.f.a - shell404.camera.a) * shell404.adaptiveCam.delta,
                shell404.camera.va += (shell404.adaptiveCam.f.va - shell404.camera.va) * shell404.adaptiveCam.delta,
                shell404.applyCamAngles(),
                shell404.statsEnabled && shell404.stats.update(),
                shell404.renderer.render(shell404.scene, shell404.camera),
                requestAnimFrame(shell404.update)
            },
            this.addIndicators = function() {
                ...
                shell404.addLine(shell404.origin, e, 16711680),
                shell404.addLine(shell404.origin, t, 65280),
                shell404.addLine(shell404.origin, n, 255),
                shell404.addLine(new THREE.Vector3( - shell404.maxRadius, 0, -shell404.maxRadius), new THREE.Vector3(shell404.maxRadius, 0, -shell404.maxRadius), 16777215),
                shell404.addLine(new THREE.Vector3( - shell404.maxRadius, 0, -shell404.maxRadius), new THREE.Vector3( - shell404.maxRadius, 0, shell404.maxRadius), 16777215)
            },
    ...
    6 : [function() {
        window.Stats = function() {
            ...
            f = 1e3,
            m = 0,
            _ = [[16, 16, 48], [0, 255, 255]],
            g = 0,
            v = 1e3,
            b = 0,
            w = [[16, 48, 16], [0, 255, 0]];
            for (e = document.createElement("div"), e.style.cursor = "pointer", e.style.width = "80px", e.style.opacity = "0.9", e.style.zIndex = "10001", e.addEventListener("mousedown",
            function(e) {
                e.preventDefault(),
                l = (l + 1) % 2,
                0 == l ? (n.style.display = "block", s.style.display = "none") : (n.style.display = "none", s.style.display = "block")
            },
            !1), n = document.createElement("div"), n.style.textAlign = "left", n.style.lineHeight = "1.2em", n.style.backgroundColor = "rgb(" + Math.floor(_[0][0] / 2) + "," + Math.floor(_[0][1] / 2) + "," + Math.floor(_[0][2] / 2) + ")", n.style.padding = "0 0 3px 3px", e.appendChild(n), i = document.createElement("div"), i.style.fontFamily = "Helvetica, Arial, sans-serif", i.style.fontSize = "9px", i.style.color = "rgb(" + _[1][0] + "," + _[1][1] + "," + _[1][2] + ")", i.style.fontWeight = "bold", i.innerHTML = "FPS", n.appendChild(i), o = document.createElement("div"), o.style.position = "relative", o.style.width = "74px", o.style.height = "30px", o.style.backgroundColor = "rgb(" + _[1][0] + "," + _[1][1] + "," + _[1][2] + ")", n.appendChild(o); o.children.length < 74;) t = document.createElement("span"),
            t.style.width = "1px",
            t.style.height = "30px",
            t.style.cssFloat = "left",
            t.style.backgroundColor = "rgb(" + _[0][0] + "," + _[0][1] + "," + _[0][2] + ")",
            o.appendChild(t);
            for (s = document.createElement("div"), s.style.textAlign = "left", s.style.lineHeight = "1.2em", s.style.backgroundColor = "rgb(" + Math.floor(w[0][0] / 2) + "," + Math.floor(w[0][1] / 2) + "," + Math.floor(w[0][2] / 2) + ")", s.style.padding = "0 0 3px 3px", s.style.display = "none", e.appendChild(s), r = document.createElement("div"), r.style.fontFamily = "Helvetica, Arial, sans-serif", r.style.fontSize = "9px", r.style.color = "rgb(" + w[1][0] + "," + w[1][1] + "," + w[1][2] + ")", r.style.fontWeight = "bold", r.innerHTML = "MS", s.appendChild(r), a = document.createElement("div"), a.style.position = "relative", a.style.width = "74px", a.style.height = "30px", a.style.backgroundColor = "rgb(" + w[1][0] + "," + w[1][1] + "," + w[1][2] + ")", s.appendChild(a); a.children.length < 74;) t = document.createElement("span"),
            t.style.width = "1px",
            t.style.height = 30 * Math.random() + "px",
            t.style.cssFloat = "left",
            t.style.backgroundColor = "rgb(" + w[0][0] + "," + w[0][1] + "," + w[0][2] + ")",
            a.appendChild(t);
            return {
                domElement: e,
                update: function() {
                    ...
                    v = Math.min(v, g),
                    b = Math.max(b, g),
                    r.textContent = g + " MS (" + v + "-" + b + ")";
                    var e = Math.min(30, 30 - g / 200 * 30);
                    a.appendChild(a.firstChild).style.height = e + "px",
                    u = c,
                    d++,
                    c > h + 1e3 && (p = Math.round(1e3 * d / (c - h)), f = Math.min(f, p), m = Math.max(m, p), i.textContent = p + " FPS (" + f + "-" + m + ")", e = Math.min(30, 30 - p / 100 * 30), o.appendChild(o.firstChild).style.height = e + "px", h = c, d = 0)
                }
            }
        }
    },
    ...
    7 : [function() { !
        function() {
            ...
            function() {
                ...
                e._tweens = [],
                e._plugins = {},
                e.get = function(t, n, i, o) {
                    return o && e.removeTweens(t),
                    new e(t, n, i)
                },
                e.tick = function(t, n) {
                ...
                createjs.Ticker && createjs.Ticker.addListener(e, !1),
                e.removeTweens = function(t) {
                    if (t.tweenjs_count) {
                        for (var n = e._tweens,
                        i = n.length - 1; i >= 0; i--) n[i]._target == t && (n[i]._paused = !0, n.splice(i, 1));
                        t.tweenjs_count = 0
                    }
                },
                ...
                t._target = null,
                t._useTicks = !1,
                t.initialize = function(t, n, i) {
                    this.target = this._target = t,
                    n && (this._useTicks = n.useTicks, this.ignoreGlobalPause = n.ignoreGlobalPause, this.loop = n.loop, this.onChange = n.onChange, n.override && e.removeTweens(t)),
                    this.pluginData = i || {},
                    this._curQueueProps = {},
                ...
                t.setPosition = function(e, t) {
                    ...
                    var o = this._prevPos;
                    if (this.position = this._prevPos = n, this._prevPosition = e, this._target) if (i) this._updateTargetProps(null, 1);
                    else if (0 < this._steps.length) {
                        for (var s = 0,
                        r = this._steps.length; r > s && !(this._steps[s].t > n); s++);
                        s = this._steps[s - 1],
                        this._updateTargetProps(s, (this._stepPosition = n - s.t) / s.d)
                    }
                    return 0 != t && 0 < this._actions.length && (this._useTicks ? this._runActions(n, n) : 1 == t && o > n ? (o != this.duration && this._runActions(o, this.duration), this._runActions(0, n, !0)) : this._runActions(o, n)),
                    i && this.setPaused(!0),
                ...
                t._updateTargetProps = function(t, i) {
                    ...
                    for (n in this._initQueueProps) {
                        null == (r = o[n]) && (o[n] = r = this._initQueueProps[n]),
                        null == (a = s[n]) && (s[n] = a = r),
                        r = r == a || 0 == i || 1 == i || "number" != typeof r ? 1 == i ? a: r: r + (a - r) * i;
                        var l = !1;
                        if (a = e._plugins[n]) for (var d = 0,
                        c = a.length; c > d; d++) {
                ...
                t._runActions = function(e, t, n) {
                    ...
                    a = 1;
                    for (e > t && (i = t, o = e, s = r, r = a = -1); (s += a) != r;) {
                        t = this._actions[s];
                        var l = t.t; (l == o || l > i && o > l || n && l == e) && t.f.apply(t.o, t.p)
                    }
                },
                t._appendQueueProps = function(t) {
                    ...
                    for (a in t) {
                        if (void 0 === this._initQueueProps[a]) {
                            if (i = this._target[a], n = e._plugins[a]) for (o = 0, s = n.length; s > o; o++) i = n[o].init(this, a, i);
                            this._initQueueProps[a] = void 0 === i ? null: i
                        } else i = this._curQueueProps[a];
                        if (n = e._plugins[a]) for (r = r || {},
                        o = 0, s = n.length; s > o; o++) n[o].step && n[o].step(this, a, i, t[a], r);
            ...
            function() {
                ...
                t.initialize = function(e, t, n) {
                    this._tweens = [],
                    n && (this._useTicks = n.useTicks, this.loop = n.loop, this.ignoreGlobalPause = n.ignoreGlobalPause, this.onChange = n.onChange),
                ...
                t.removeTween = function(e) {
                    ...
                    if (t > 1) {
                        for (var n = !0,
                        i = 0; t > i; i++) n = n && this.removeTween(arguments[i]);
                        return n
                    }
                ...
                t.setPosition = function(e, t) {
                    ...
                    for (var o = 0,
                    s = this._tweens.length; s > o; o++) if (this._tweens[o].setPosition(n, t), n != this._prevPos) return ! 1;
                ...
                t.updateDuration = function() {
                    for (var e = this.duration = 0,
                    t = this._tweens.length; t > e; e++) tween = this._tweens[e],
            ...
            function() {
                ...
                e.step = function(t, n, i, o, s) {
                    ...
                    for (o._segments = [], o._length = 0, n = 2; i > n; n += 4) {
                        for (var a, l, d = t[n - 2], c = t[n - 1], u = t[n + 0], h = t[n + 1], p = t[n + 2], f = t[n + 3], m = d, _ = c, g = 0, v = [], b = 1; 10 >= b; b++) {
                            l = b / 10;
                            var w = 1 - l;
                            a = w * w * d + 2 * w * l * u + l * l * p,
                            l = w * w * c + 2 * w * l * h + l * l * f,
                            g += v[v.push(Math.sqrt((r = a - m) * r + (r = l - _) * r)) - 1],
                            m = a,
                            _ = l
                        }
                        o._segments.push(g),
                ...
                e.tween = function(t, n, i, o, s, r, a) {
                    return s = s.guide,
                    void 0 == s || s === o.guide ? i: (s.lastRatio != r && (e.calc(s, (s.end - s.start) * (a ? s.end: r) + s.start, t.target), s.orient && (t.target.rotation += o.rotation || 0), s.lastRatio = r), s.orient || "rotation" != n ? t.target[n] : i)
                },
                e.calc = function(t, n, i) {
                    ...
                    r = t._length * n,
                    a = o.length - 2;
                    for (n = 0; r > o[n] && a > n;) r -= o[n],
                    n += 2;
                    for (var o = o[n + 1], l = 0, a = o.length - 1; r > o[l] && a > l;) r -= o[l],
                    l++;
                    return r = l / ++a + r / (a * o[l]),
                    n = 2 * n + 2,
                    a = 1 - r,
                    i.x = a * a * s[n - 2] + 2 * a * r * s[n + 0] + r * r * s[n + 2],
                    i.y = a * a * s[n - 1] + 2 * a * r * s[n + 1] + r * r * s[n + 3],
                    t.orient && (i.rotation = 57.2957795 * Math.atan2((s[n + 1] - s[n - 1]) * a + (s[n + 3] - s[n + 1]) * r, (s[n + 0] - s[n - 2]) * a + (s[n + 2] - s[n + 0]) * r)),
                    i
                },
            ...
            function() {
                ...
                e.version = "0.4.0",
                e.buildDate = "Tue, 12 Feb 2013 21:09:02 GMT"
            } ()
        } (window)
    },
    {}],
    8 : [function() {
        ...
        dat.utils.common = function() {
            ...
            return {
                BREAK: {},
                extend: function(e) {
                    return this.each(t.call(arguments, 1),
                    function(t) {
                ...
                each: function(t, n, i) {
                    if (e && t.forEach === e) t.forEach(n, i);
                        ...
                        for (var o = 0,
                        s = t.length; s > o; o++) if (o in t && n.call(i, t[o], o) === this.BREAK) return
        ...
        dat.controllers.NumberControllerBox = function(e, t, n) {
            ...
            n.extend(o.prototype, e.prototype, {
                updateDisplay: function() {
                    return this.__input.value = this.__truncationSuspended ? this.getValue() : i(this.getValue(), this.__precision),
        ...
        dat.controllers.NumberControllerSlider = function(e, t, n, i, o) {
            ...
            var r = function(e, n, i, o, a) {
                ...
                function d(e) {
                    ...
                    return u.setValue(s(e.clientX, n.left, n.left + i, u.__min, u.__max)),
                    !1
                }
                function c() {
                    t.unbind(window, "mousemove", d),
        ...
        dat.color.interpret = function(e, t) {
            var n, i, o = function() {
                ...
                return t.each(s,
                function(o) {
                    return o.litmus(e) ? (t.each(o.conversions,
                    function(o, s) {
                        return n = o.read(e),
                        i === !1 && n !== !1 ? (i = n, n.conversionName = s, n.conversion = o, t.BREAK) : void 0
                    }), t.BREAK) : void 0
                }),
                i
            },
        ...
        dat.GUI = dat.gui.GUI = function(e, t, n, i, o, s, r, a, l, d, c, u, h, p, f) {
            function m(e, t, n, s) {
                ...
                s.before instanceof o && (s.before = s.before.__li),
                v(e, r),
                p.addClass(r.domElement, "c");
                var l = document.createElement("span");
                p.addClass(l, "property-name"),
                l.innerHTML = r.property;
                var d = document.createElement("div");
                d.appendChild(l),
                d.appendChild(r.domElement);
                var u = _(e, d, s.before);
                return p.addClass(u, N.CLASS_CONTROLLER_ROW),
                p.addClass(u, typeof r.getValue()),
                g(e, u, r),
            ...
            function _(e, t, n) {
                ...
                n ? e.__ul.insertBefore(i, params.before) : e.__ul.appendChild(i),
                e.onResize(),
                i
            }
            function g(e, t, n) {
                if (n.__li = t, n.__gui = e, f.extend(n, {
                    ...
                    f.each(["updateDisplay", "onChange", "onFinishChange"],
                    function(e) {
                        var t = n[e],
                        o = i[e];
                        n[e] = i[e] = function() {
                    ...
                    n.min = f.compose(o, n.min),
                    n.max = f.compose(o, n.max)
                } else n instanceof s ? (p.bind(t, "click",
                function() {
                    p.fakeEvent(n.__checkbox, "click")
                }), p.bind(n.__checkbox, "click",
                function(e) {
                    e.stopPropagation()
                })) : n instanceof r ? (p.bind(t, "click",
                function() {
            ...
            function v(e, t) {
                ...
                if ( - 1 != i) {
                    ...
                    if (void 0 === o && (o = {},
                    n.__rememberedObjectIndecesToControllers[i] = o), o[t.property] = t, n.load && n.load.remembered) {
            ...
            function w(e) {
                ...
                s.innerHTML = "New",
                p.addClass(s, "button"),
                p.addClass(s, "save-as");
                var r = document.createElement("span");
                r.innerHTML = "Revert",
                p.addClass(r, "button"),
                p.addClass(r, "revert");
                var a = e.__preset_select = document.createElement("select");
                if (e.load && e.load.remembered ? f.each(e.load.remembered,
                function(t, n) {
                    C(e, n, n == e.preset)
                }) : C(e, H, !1), p.bind(a, "change",
                function() {
                ...
                p.bind(u, "keydown",
                function(e) { ! e.metaKey || 67 !== e.which && 67 != e.keyCode || P.hide()
                }),
                p.bind(i, "click",
                function() {
            ...
            function y(e) {
                function t(t) {
                    ...
                    o = t.clientX,
                    p.addClass(e.__closeButton, N.CLASS_DRAG),
                ...
                function i() {
                    p.removeClass(e.__closeButton, N.CLASS_DRAG),
            ...
            function x(e, t) {
                var n = {};
                return f.each(e.__rememberedObjects,
                function(i, o) {
                    var s = {},
            ...
            N = function(e) {
                ...
                f.isUndefined(e.parent) && e.hideable && z.push(this),
                ...
                if (Object.defineProperties(this, {
                    ...
                    closed: {
                        ...
                        set: function(t) {
                            e.closed = t,
                            e.closed ? p.addClass(i.__ul, N.CLASS_CLOSED) : p.removeClass(i.__ul, N.CLASS_CLOSED),
                            this.onResize(),
                            i.__closeButton && (i.__closeButton.innerHTML = t ? N.TEXT_OPEN: N.TEXT_CLOSED)
                        }
                    },
                    load: {
                        get: function() {
                    ...
                    p.addClass(this.__closeButton, N.CLASS_CLOSE_BUTTON),
                    this.domElement.appendChild(this.__closeButton),
                    p.bind(this.__closeButton, "click",
                    function() {
                        i.closed = !i.closed
                    })
                } else {
                    ...
                    p.addClass(this.__ul, N.CLASS_CLOSED),
                    p.addClass(a, "title"),
                    p.bind(a, "click", l),
                    e.closed || (this.closed = !1)
                }
                e.autoPlace && (f.isUndefined(e.parent) && (L && (R = document.createElement("div"), p.addClass(R, M), p.addClass(R, N.CLASS_AUTO_PLACE_CONTAINER), document.body.appendChild(R), L = !1), R.appendChild(this.domElement), p.addClass(this.domElement, N.CLASS_AUTO_PLACE)), this.parent || E(i, e.width)),
                p.bind(window, "resize",
                function() {
                    i.onResize()
                }),
                p.bind(this.__ul, "webkitTransitionEnd",
                function() {
                    i.onResize()
                }),
                p.bind(this.__ul, "transitionend",
                function() {
                    i.onResize()
                }),
                p.bind(this.__ul, "oTransitionEnd",
                function() {
                    i.onResize()
                }),
                this.onResize(),
            ...
            return N.toggleHide = function() {
                ...
                f.each(z,
                function(e) {
                    e.domElement.style.zIndex = j ? -999 : 999,
                    e.domElement.style.opacity = j ? 0 : 1
                })
            },
            N.CLASS_AUTO_PLACE = "a",
            N.CLASS_AUTO_PLACE_CONTAINER = "ac",
            N.CLASS_MAIN = "main",
            N.CLASS_CONTROLLER_ROW = "cr",
            N.CLASS_TOO_TALL = "taller-than-window",
            N.CLASS_CLOSED = "closed",
            N.CLASS_CLOSE_BUTTON = "close-button",
            N.CLASS_DRAG = "drag",
            N.DEFAULT_WIDTH = 245,
            N.TEXT_CLOSED = "Close Controls",
            N.TEXT_OPEN = "Open Controls",
            p.bind(window, "keydown",
            function(e) {
            ...
            f.extend(N.prototype, {
                ...
                remember: function() {
                    ...
                    var e = this;
                    f.each(Array.prototype.slice.call(arguments),
                    function(t) {
            ...
            var a = function(e, l) {
                ...
                t.bind(this.__selector, "mousedown",
                function() {
                    t.addClass(this, "drag").bind(window, "mouseup",
                    function() {
                ...
                o.extend(this.__hue_field.style, {
                    width: "15px",
                    height: "100px",
                    display: "inline-block",
                    border: "1px solid #555",
                ...
                t.bind(this.__hue_field, "mousedown",
                function(e) {
                    f(e),
            ...
            function o(e, t, n) {
                Object.defineProperty(e, t, {
                    ...
                    set: function(e) {
                        "RGB" !== this.__state.space && (r(this, t, n), this.__state.space = "RGB"),
                        this.__state[t] = e
                    }
                })
            }
            ...
            return {
                hsv_to_rgb: function(e, t, n) {
                    ...
                    r = n * (1 - o * t),
                    a = n * (1 - (1 - o) * t),
                    l = [[n, a, s], [r, n, s], [s, n, a], [s, r, n], [a, s, n], [n, s, r]][i];
                    return {
                        r: 255 * l[0],
                        g: 255 * l[1],
                        b: 255 * l[2]
            ...
            var n = function() {
                ...
                var n = this;
                e.bind(this.backgroundElement, "click",
                function() {
                    n.hide()
                })
            };
